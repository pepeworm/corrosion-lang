...
export default function Navbar() {
	...
	return (
		<>
			<nav className="backdrop-blur-xl px-12 py-2 flex flex-row justify-between border-b items-center border-border text-text-header fixed top-0 right-0 left-0 z-40">
				<div>
					<Link
						href="/"
						className="flex flex-row justify-center items-center gap-[0.1rem]"
					>
			...
			<div
				className={`absolute right-8 top-12 z-40 transition-opacity duration-200 ${
					!github
						? "z-0 opacity-0"
						: "flex flex-row-reverse opacity-100"
				}`}
			>
